CC = /usr/bin/g++
#CC = /usr/local/src/usr/local/arm/4.4.1/bin/arm-linux-g++
#CFLAGS = -Wall -g -O4 -I..
CFLAGS = -g -O4 -I.. 

all:	main main_interface main_tracegen main_nfa main_dfas main_regexgen exe
...
classify.o:  stdinc.h dfa.h classify.h 
crosslist.o:  stdinc.h crosslist.h

main: stdinc.o int_set.o linked_set.o dheap.o partition.o wgraph.o dfa.o nfa.o subset.o parser.o trace.o hybrid_fa.o main.o cache.o fa_memory.o dfas_memory.o classify.o crosslist.o
	${CC} ${CFLAGS} stdinc.o int_set.o linked_set.o partition.o wgraph.o dheap.o dfa.o nfa.o subset.o parser.o main.o trace.o hybrid_fa.o cache.o fa_memory.o dfas_memory.o classify.o crosslist.o -o regex 

main_interface: stdinc.o int_set.o linked_set.o dheap.o partition.o wgraph.o dfa.o nfa.o subset.o parser.o trace.o hybrid_fa.o main_interface.o cache.o fa_memory.o dfas_memory.o classify.o crosslist.o
	${CC} ${CFLAGS} stdinc.o int_set.o linked_set.o partition.o wgraph.o dheap.o dfa.o nfa.o subset.o parser.o main_interface.o trace.o hybrid_fa.o cache.o fa_memory.o dfas_memory.o classify.o crosslist.o -o main_interface 	
